...
Estas abordagens exploradas são: a reutilização de software, arquitetura orientada a serviços, utilização de containers em Docker e Kubernetes e práticas e métodos de testes de software em Spring Boot, com ênfase nos testes baseados em serviços.
